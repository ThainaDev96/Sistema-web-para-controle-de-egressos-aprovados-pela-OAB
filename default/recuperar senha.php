                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="email-address" class="form-control" required="" placeholder="Seu endereço de email">
                                    <span class="form-bar"></span>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Redefinir senha</button>
                                    </div>
                                </div>
                                <p class="f-w-600 text-right"><a href="login.php">Voltar para Login.</a></p>
                                <div class="row">
                                    <div class="col-md-10">
