            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="login_processa.php" method="post">
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    if (!empty($_SESSION['login_erro'])) {
                                        echo '<div style="color:red; font-weight:bold; margin-bottom:10px; text-align:center;">' . $_SESSION['login_erro'] . '</div>';
                                        unset($_SESSION['login_erro']); // limpa a mensagem
                                    }
                                    ?>
                                    <div class="form-group form-primary">
                                        <input type="text" name="email" class="form-control" required="" placeholder="Seu endereço de email">
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="recuperar senha.php" class="text-right f-w-600"> Esqueceu sua senha?</a>
                                            </div>
                                        </div>
                                    </div>
