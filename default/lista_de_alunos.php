                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <?php if($_SESSION['msg'] == 'del_ok'): ?>
                                                    <div class="alert alert-danger alert-auto-hide" role="alert">
                                                        Aluno deletado com sucesso!
                                                    </div>
                                                <?php elseif($_SESSION['msg'] == 'del_fail'): ?>
                                                    <div class="alert alert-danger alert-auto-hide" role="alert">
                                                        Erro ao tentar deletar o aluno.
                                                    </div>
                                                <?php endif; ?>
                                                <?php unset($_SESSION['msg']); // limpa a sessão para sumir a mensagem ?>
                                            <?php endif; ?>
...
<script>
    //desaparece a mensagem de deletado
