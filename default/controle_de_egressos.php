                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>Controle de egressos por turma</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>Envie emails ou exporte contatos da turma</h5>
                                                        ...
                                                        <table id="TabelaListaAlunos" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                    <?php
                                                                    $r = $conn->query("SELECT COUNT(*) AS total FROM alunos");
                                                                    $d = $r->fetch_assoc();
                                                                    echo $d['total'];
                                                                    ?>
                                                                    </td>
                                                                    <td>
                                                                        <a href="enviar_comunicado.php">
                                                                        <button class="btn btn-out btn-primary btn-square">
                                                                            <i class="ti-email"></i>
                                                                        </button>
                                                                    </a>
                                                                     <a href="exportar_emails.php">
                                                                        <button class="btn btn-out btn-success btn-square">
                                                                            <i class="ti-export"></i>
                                                                        </button>
                                                                    </a>
                                                                </td>
